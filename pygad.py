...
class GA:
    ...
    def initialize_population(self):
        ...
        self.population = numpy.random.randint(low=0, high=4, size=self.pop_size)
    ...
    def random_mutation(self, offspring):
        ...
        for idx in range(offspring.shape[0]):
            ...
            # The random value to be added to the gene.
            random_value = numpy.random.randint(0, 4, 1)
            if random.random() <= 0.6:
                #print("muting")
                offspring[idx, mutation_indices] = (offspring[idx, mutation_indices] + random_value)%4                     
            #print("IDX: ", offspring[idx, mutation_indices])
        return offspring
